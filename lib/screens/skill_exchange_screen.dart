  ...
  final List<Map<String, dynamic>> _users = const [
    {
      ...
      'pts': 100,
      'bio':
          'Native Spanish speaker and hobby photographer. Love to meet new people!'
    },
    {
      'name': 'David Kim',
      'image':
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: const Border(
                  left: BorderSide(color: SkillSwapColors.primary, width: 4)),
              boxShadow: const [
                BoxShadow(
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                CircleAvatar(
                    backgroundImage: NetworkImage(user['image']), radius: 32),
